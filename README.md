...
Na função readSVG garantimos que o element_map está vazio e depois implementamos um ciclo for que percorre todos os elementos da raiz do ficheiro. Cada elemento percorrido é processado pela função parse_element que analisa e extrai as propriedades geométricas e visuais para instanciar as respetivas classes de figuras. Após essa análise, caso o elemento processado exista, ele é adicionado ao vetor svg_elements. 
